...
public class ModCreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> CREATIVE_TAB = CREATIVE_MODE_TABS.register("homesweethome",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(Items.LEMON.get()))
                    .title(Component.translatable("creativetab.homesweethome"))
                    .displayItems((pParameters, pOutput) -> {
                        pOutput.accept(Items.LEMON.get());
                    })
                    .build());
